...
- one hooks component is useState that allows fn component to access state. useState gives as a variable and a setter for that variable inside state, while taking an initial value. 