...
- every router loaded component is passed three params.(url ,path and component). Url will be the url matched, and if multiple urls are matched for a page, the url passed will be the url till the match was found. Eg 
